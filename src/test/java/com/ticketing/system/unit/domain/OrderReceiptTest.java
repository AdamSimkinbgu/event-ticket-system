...
class OrderReceiptTest {
    ...
    void testForMemberSetsUserIdCorrectly() {
        OrderReceipt receipt = OrderReceipt.forMember(5, 100.0, new ArrayList<>());
    ...
    void testForGuestSetsGuestEmailCorrectly() {
        OrderReceipt receipt = OrderReceipt.forGuest("test@test.com", "session-123", 100.0, new ArrayList<>());

...
public class OrderReceiptMapper {
    ...
    public PurchaseHistoryDTO.PurchaseRecordDTO OrderReceiptToPurchaseRecordDTO(
            OrderReceipt sale, ITicketRepository ticketRepository, IEventRepository eventRepository) {
    ...
    List<PurchaseHistoryDTO.TicketRecordDTO> ticketRecords = tickets.stream().map(Ticket::toTicketRecordDTO).toList();
